...
local Anims = {}
function Animator:Animate(Instance, Properties, Duration, ...)
	local Tween = Handler.Services.TweenService:Create(Instance, TweenInfo.new(Duration, ...), Properties)
    table.insert(Anims, Tween)
	Tween:Play()
	return Tween
end

function Animator:StopAllAnims()
